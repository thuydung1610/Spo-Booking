"""
Django settings for spo_booking project.
...
SECRET_KEY = 'django-insecure-jq03f=_#lsyt=aoeb#!y$ab--8s6bx6_tvyt2!7m1u=&^54pr^'
...
WSGI_APPLICATION = 'spo_booking.wsgi.application'
